...
root.geometry("1707x1000")

user_account_ui=customtkinter.CTkImage(light_image=Image.open("Project Images/DriveEase UI.png"),size=(root.winfo_screenwidth(),root.winfo_screenheight()-54))
