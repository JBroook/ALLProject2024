...
rate_booking_ui=customtkinter.CTkImage(light_image=Image.open("Project Images/Rate Car Booking.png"),size=(root2.winfo_screenwidth(),root2.winfo_screenheight()-68))
...
car_name=customtkinter.CTkLabel(root2,width=457/1707*root2.winfo_screenwidth(),height=54/1067*root2.winfo_screenheight(),fg_color="#FFFFFF",bg_color="#FFFFFF",text=booking[4],text_color="#000000",font=("Poppins",56))
car_name.place(x=317/1707*root2.winfo_screenwidth(),y=203/1067*root2.winfo_screenheight(),anchor="nw")
...
btn1=customtkinter.CTkButton(root2,width=79/1707*root2.winfo_screenwidth(),height=75/1067*root2.winfo_screenheight(),bg_color="white",fg_color="#EFBF14",text="☆",text_color="#000000",font=("Poppins",32))
btn1.place(x=1084/1707*root2.winfo_screenwidth(),y=182/1067*root2.winfo_screenheight(),anchor="nw")

btn2=customtkinter.CTkButton(root2,width=79/1707*root2.winfo_screenwidth(),height=75/1067*root2.winfo_screenheight(),bg_color="white",fg_color="#EFBF14",text="☆",text_color="#000000",font=("Poppins",32))
btn2.place(x=1179/1707*root2.winfo_screenwidth(),y=182/1067*root2.winfo_screenheight(),anchor="nw")

btn3=customtkinter.CTkButton(root2,width=79/1707*root2.winfo_screenwidth(),height=75/1067*root2.winfo_screenheight(),bg_color="white",fg_color="#EFBF14",text="☆",text_color="#000000",font=("Poppins",32))
btn3.place(x=1274/1707*root2.winfo_screenwidth(),y=182/1067*root2.winfo_screenheight(),anchor="nw")

btn4=customtkinter.CTkButton(root2,width=79/1707*root2.winfo_screenwidth(),height=75/1067*root2.winfo_screenheight(),bg_color="white",fg_color="#EFBF14",text="☆",text_color="#000000",font=("Poppins",32))
btn4.place(x=1369/1707*root2.winfo_screenwidth(),y=182/1067*root2.winfo_screenheight(),anchor="nw")

btn5=customtkinter.CTkButton(root2,width=79/1707*root2.winfo_screenwidth(),height=75/1067*root2.winfo_screenheight(),bg_color="white",fg_color="#EFBF14",text="☆",text_color="#000000",font=("Poppins",32))
btn5.place(x=1464/1707*root2.winfo_screenwidth(),y=182/1067*root2.winfo_screenheight(),anchor="nw")

bck_btn=customtkinter.CTkButton(root2,width=171/1707*root2.winfo_screenwidth(),height=69/1067*root2.winfo_screenheight(),bg_color="white",fg_color="#1572D3",text="Back",text_color="white",font=("Poppins",24))
bck_btn.place(x=72/1707*root2.winfo_screenwidth(),y=878/1067*root2.winfo_screenheight(),anchor="nw")

confirm_btn=customtkinter.CTkButton(root2,width=171/1707*root2.winfo_screenwidth(),height=69/1067*root2.winfo_screenheight(),bg_color="white",fg_color="#1572D3",text="Confirm",text_color="white",font=("Poppins",24))
confirm_btn.place(x=1389/1707*root2.winfo_screenwidth(),y=786/1067*root2.winfo_screenheight(),anchor="nw")
