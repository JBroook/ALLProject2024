...
class App:
    ...
    def login(self):
        for i in self.master.winfo_children():
            i.destroy()
        loginPage = ctk.CTkFrame(self.master)
        ...
        usernameEntry = ctk.CTkEntry(usernameFrame, textvariable=self.username)
        ...
        passwordEntry = ctk.CTkEntry(passwordFrame, show="*", textvariable=self.password)
        passwordEntry.pack(side="left")
        passwordFrame.pack(anchor="center", pady="10")

        # login/register frame
        loginButtonFrame = ctk.CTkFrame(loginPage)
        loginButton = ctk.CTkButton(loginButtonFrame, text="Login", command=self.test_credentials)
        loginButton.pack(side="left", padx="5")
        registerButton = ctk.CTkButton(loginButtonFrame, text="Register", command=self.register)
    ...
    def home_page(self):
        ...
        homepage_bg = ctk.CTkImage(light_image=img.open("assets/homepage bg.png"),
                                          size=(1920, 800))
        ...
        rent_button = ctk.CTkButton(self.master,text="Rent a car",width=400,height=500,font=("Inter",36),bg_color="#EEEEEE",fg_color="#393E46",border_width=5, hover_color="#222831")
